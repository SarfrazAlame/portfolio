...
const serviceData = [
    {
        ...
        title: 'Web Design',
        description: `Lorem ipsum dolor,  eatae aliquid dolor dolores.`
    },
    {
        icon: <Blocks size={72} strokeWidth={0.8} />,
        title: 'Web Development',
        description: `Lorem ipsum dolor, s id dolor dolores.`
    },
    {
        icon: <Gem size={72} strokeWidth={0.8} />,
        title: 'Web Design',
        description: `Lorem ipsum dolo mos beatae aliquid dolor dolores.`
    },
]
const Service = () => {
    return (
